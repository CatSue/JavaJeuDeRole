...
public class Heros extends EtreVivant{
    ...
    */
    public Heros(String pNom, String pType, int pPv, Arme pArme) {
    ...
    */
    ...
    public void Attaquer(EtreVivant cible){
        System.out.println("Nom du hero : " + nom + ", Nom de la cible : " + cible.getNom());
        arme.Attaque();
   }
    ...
    */
    ...
    public void RecevoirDegats (EtreVivant source){
        System.out.println("Nom du hero : " + nom + ", Nom de la source : " + source.getNom());
    }
}
